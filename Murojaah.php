...
if (isset($_POST["tambah"])) {
    ...
    // Query inser data
    $query = "INSERT INTO murajaah (Nama_M, Ayat_m, Tanggal_m, Keterangan_m) VALUES ('$nama', '$ayat', '$Tanggal', '$Keterangan')";
    ...
    <div class="row g-0">
        ...
        <div class="col-10 d-flex flex-column min-vh-100">
            ...
            <div class="header shadow  px-3 py-4 d-flex justify-content-between align-items-center">
                <h5 class="content m-0 d-flex ">Laporan Murojaah</h5>
                <div class="dropdown">
            ...
            <section class="wajib flex-grow-1">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="nama" name="Nama_M" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="Ayat" class="form-label">Ayat Surah</label>
                                        <input type="text" class="form-control" id="Ayat" name="Ayat_m" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="tanggal">Masukkan tanggal:</label>
                                        <input type="date" class="form-control" id="tanggal" name="Tanggal_m" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="keterangan">Keterangan</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="Keterangan_m" required></textarea>
                                    </div>
                ...
                <div class="card px-3 py-2 m-3 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php $hasil = mysqli_query($con, 'SELECT * FROM murajaah'); ?>
                        <?php
                                        ...
                                        <div class="modal fade" id="updateLaporanModal<?= $i ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="ubahm.php" method="POST">
                                                            <!-- [id] adalah nama id dapat dari kolom table yang bernama id karena i variabel sendiri -->
                                                            <input type="hidden" name="id" value="<?= $row["id"] ?>">
                                                            <div class="mb-3">
                                                                <label for="nama" class="form-label">Nama Surah</label>
                                                                <input type="text" class="form-control" id="nama" name="Nama_M" value="<?= $row['Nama_M'] ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="Ayat" class="form-label">Ayat Surah</label>
                                                                <input type="text" class="form-control" id="Ayat" name="Ayat_m" value="<?= $row['Ayat_m'] ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="tanggal">Masukkan tanggal:</label>
                                                                <input type="date" class="form-control" id="tanggal" name="Tanggal_m" value="<?= $row['Tanggal_m'] ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="keterangan">Keterangan</label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="Keterangan_m" required><?= $row['Keterangan_m'] ?></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapusm.php?id=<?= $row['id'] ?>" class="btn btn-danger">Hapus</a>
