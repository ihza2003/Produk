...
// $result = mysqli_query($con, 'SELECT * from sholat_wajib');
if (isset($_POST["tambah"])) {
    ...
    // Query inser data
    $query = "INSERT INTO sholat_wajib (Nama_Wajib, Tanggal, Keterangan) VALUES ('$nama', '$Tanggal', '$Keterangan')";
...
// Update data
// Ambil data untuk diupdate
// if (isset($_GET['id'])) {
//     $id = $_GET['id'];
//     $query = "SELECT * FROM sholat_wajib WHERE id = $id";
//     $result = mysqli_query($con, $query);
...
<body>
    <div class="row g-0 ">
        ...
        <!-- <div class="col-10 g-0 d-flex flex-column min-vh-100"> -->
        <div class="col-10 d-flex flex-column min-vh-100">
            ...
            <div class="header shadow  px-3 py-4 d-flex justify-content-between align-items-center">
                <h5 class="content m-0 d-flex ">Laporan Sholat Wajib</h5>
                <div class="dropdown">
            ...
            <section class="wajib flex-grow-1">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" id="nama" name="Nama_Wajib">
                                            <option value=""></option>
                ...
                <div class="card px-3 py-2 m-3 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php $hasil = mysqli_query($con, 'SELECT * FROM sholat_wajib'); ?>
                        <?php
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="ubah.php" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="nama" class="form-label">Nama Sholat</label>
                                                                <select class="form-control" id="nama" name="Nama_Wajib">
                                                                    <option value="<?= $row['Nama_Wajib'] ?>"><?= $row['Nama_Wajib'] ?></option>
                                                                    <option value="shubuh">Shubuh</option>
                                                                    <option value="zuhur">Zuhur</option>
                                                                    <option value="ashar">Ashar</option>
                                                                    <option value="maghrib">Maghrib</option>
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="keterangan">Keterangan</label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="Keterangan" required><?= $row['Keterangan'] ?></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
