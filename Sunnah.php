...
if (isset($_POST["tambah"])) {
    ...
    // Query inser data
    $query = "INSERT INTO sunnah (Nama_Sunnah, Tanggal_Sunnah, Keterangan_s) VALUES ('$nama', '$Tanggal', '$Keterangan')";
    ...
    <div class="row g-0">
        ...
        <div class="col-10 d-flex flex-column min-vh-100">
            ...
            <div class="header shadow  px-3 py-4 d-flex justify-content-between align-items-center">
                <h5 class="content m-0 d-flex ">Laporan Sholat Sunnah</h5>
                <div class="dropdown">
            ...
            <section class="wajib flex-grow-1">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form action="" method="POST">
                                    <div class="mb-3">
                                        <label for="nama" class="form-label">Nama Sholat</label>
                                        <select class="form-control" id="nama" name="Nama_Sunnah">
                                            <option value=""></option>
                                            <option value="Dhuhah">Sholat Dhuhah</option>
                                            <option value="Sholat tahajud">Sholat Tahajud</option>
                                            <option value="Sholat Sunnah Rawatib">Sholat Sunnah Rawatib</option>
                                            <option value="Sholat Tahiyyatul Masjid">Sholat Tahiyyatul Masjid</option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="tanggal">Masukkan tanggal:</label>
                                        <input type="date" class="form-control" id="tanggal" name="Tanggal_Sunnah" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="keterangan">Keterangan</label>
                                        <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="Keterangan_s" required></textarea>
                                    </div>
                ...
                <div class="card px-3 py-2 m-3 shadow">
                    ...
                    <div class="card-body">
                        ...
                        <?php $hasil = mysqli_query($con, 'SELECT * FROM sunnah'); ?>
                        <?php
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            <td><?= $i; ?></td>
                                            <td><?= $row["Tanggal_Sunnah"]; ?></td>
                                            <td><?= $row["Nama_Sunnah"]; ?></td>
                                            <td><?= $row["Keterangan_s"]; ?></td>
                                            <td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <form action="ubahs.php" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                <label for="tanggal">Masukkan tanggal:</label>
                                                                <input type="date" class="form-control" id="tanggal" name="Tanggal_Sunnah" value="<?= $row['Tanggal_Sunnah'] ?>" required>
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="keterangan">Keterangan</label>
                                                                <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="Keterangan_s" required><?= $row['Keterangan_s'] ?></textarea>
                                                            </div>
                                                            <div class="modal-footer">
                                                                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <a href="hapus_s.php?id=<?= $row['id'] ?>" class="btn btn-danger">Hapus</a>
